...
/**
 * Subscribe block — feed URL + credentials + one-tap subscribe links for
 * the three major podcast apps. Editorial register (no icons; mono code,
 * compact metadata).
 */
export function PodcastSubscribeBlock({ feedUrl, title, auth }: Props) {
  ...
  // Apple / Overcast / Pocket Casts each have URL schemes for one-tap subscribe.
  // Apple Podcasts: `podcast://<host>/<path>` (https-stripped)
